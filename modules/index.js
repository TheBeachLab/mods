module_label('apa')
module_menu('   node','modules/apa/node')
...
module_menu('   slider','modules/control/slider')
...
module_menu('         rectangle corners','modules/frep/shapes/2D/rectangle%20corners')
module_menu('         right triangle','modules/frep/shapes/2D/right%20triangle')
module_label('      3D')
module_menu('         cone','modules/frep/shapes/3D/cone')
module_menu('         cube corners','modules/frep/shapes/3D/cube%20corners')
...
module_label('graph')
module_menu('   bar','modules/graph/bar')
module_label('image')
...
module_label('mesh')
module_menu('   slice','modules/mesh/slice')
module_label('module')
...
module_menu('            Epilog','modules/toolpath/machines/Roland/laser%20cutter/Epilog')
module_label('         milling')
module_menu('            MDX-20','modules/toolpath/machines/Roland/milling/MDX-20')
module_menu('            SRM-20','modules/toolpath/machines/Roland/milling/SRM-20')
